...
- Factor-based attribution modelling
- Orthogonalization of ESG risk metrics
- Multi-factor regression analysis
- Portfolio performance decomposition
- Factor exposure analysis
- Performance and risk attribution

The analytical framework was developed using:

The project demonstrates how orthogonalized ESG-related factors can be incorporated into traditional attribution frameworks to enhance investment analytics, performance evaluation and portfolio risk assessment.
